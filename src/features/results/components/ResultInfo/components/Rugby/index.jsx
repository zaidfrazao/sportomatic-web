          ...
          return (
            ...
            >
              ...
              <div className={classes.subPointWrapper}>
                ...
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {theirScore.requiredStats.tries}
                  </Typography>
                </div>
              </div>
              <div className={classes.subPointWrapper}>
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {ourScore.requiredStats.conversions}
                  </Typography>
                </div>
                <div className={classes.pointNameColumn}>
                  <Typography type="subheading" component="p">
                ...
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {theirScore.requiredStats.conversions}
                  </Typography>
                </div>
              </div>
              <div className={classes.subPointWrapper}>
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {ourScore.requiredStats.penaltyKicks}
                  </Typography>
                </div>
                <div className={classes.pointNameColumn}>
                  <Typography type="subheading" component="p">
                ...
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {theirScore.requiredStats.penaltyKicks}
                  </Typography>
                </div>
              </div>
              <div className={classes.subPointWrapper}>
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {ourScore.requiredStats.dropGoals}
                  </Typography>
                </div>
                <div className={classes.pointNameColumn}>
                  <Typography type="subheading" component="p">
                ...
                <div className={classes.subPointColumn}>
                  <Typography type="title" component="p">
                    {theirScore.requiredStats.dropGoals}
                  </Typography>
                </div>
              </div>
              {trackOptionalStats && (
              ...
              {trackOptionalStats && (
                <div className={classes.subPointWrapper}>
                  <div className={classes.subPointColumn}>
                    <Typography type="title" component="p">
                      {ourScore.optionalStats.throwIns}
                    </Typography>
                  </div>
                  <div className={classes.pointNameColumn}>
                    <Typography type="subheading" component="p">
                  ...
                  <div className={classes.subPointColumn}>
                    <Typography type="title" component="p">
                      {theirScore.optionalStats.throwIns}
                    </Typography>
                  </div>
                </div>
              )}
              {trackOptionalStats && (
                <div className={classes.subPointWrapper}>
                  ...
                  <div className={classes.subPointColumn}>
                    <Typography type="title" component="p">
                      {theirScore.optionalStats.scrums}
                    </Typography>
                  </div>
                </div>
              )}
