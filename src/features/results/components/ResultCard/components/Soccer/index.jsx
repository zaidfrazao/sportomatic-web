              ...
              {resultsStatus === "AWAITING_FINALISE" && (
                <div className={classes.subPointWrapper}>
                  <div className={classes.subPointColumn}>
                    <TextField
                      type="number"
                      value={ourScore.requiredStats.goals}
                      inputProps={{
                        min: 0
                      }}
                  ...
                  <div className={classes.subPointColumn}>
                    <TextField
                      type="number"
                      value={theirScore.requiredStats.goals}
                      inputProps={{
                        min: 0
                      }}
                ...
                trackOptionalStats && (
                  <div className={classes.subPointWrapper}>
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={ourScore.optionalStats.shots}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.ourScore.hasError}
                    ...
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={theirScore.optionalStats.shots}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.theirScore.hasError}
                ...
                trackOptionalStats && (
                  <div className={classes.subPointWrapper}>
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={ourScore.optionalStats.shotsOnTarget}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.ourScore.hasError}
                    ...
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={theirScore.optionalStats.shotsOnTarget}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.theirScore.hasError}
                ...
                trackOptionalStats && (
                  <div className={classes.subPointWrapper}>
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={ourScore.optionalStats.fouls}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.ourScore.hasError}
                    ...
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={theirScore.optionalStats.fouls}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.theirScore.hasError}
                ...
                trackOptionalStats && (
                  <div className={classes.subPointWrapper}>
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={ourScore.optionalStats.offsides}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.ourScore.hasError}
                    ...
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={theirScore.optionalStats.offsides}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.theirScore.hasError}
                ...
                trackOptionalStats && (
                  <div className={classes.subPointWrapper}>
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={ourScore.optionalStats.corners}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.ourScore.hasError}
                    ...
                    <div className={classes.subPointColumn}>
                      <TextField
                        type="number"
                        value={theirScore.optionalStats.corners}
                        inputProps={{
                          min: 0
                        }}
                        error={errors.theirScore.hasError}
