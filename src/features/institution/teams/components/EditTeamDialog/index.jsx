...
class EditTeamDialog extends Component {
  ...
  componentWillMount() {
    const { options, initialTeamInfo } = this.props;
    ...
    if (initialTeamInfo) {
      this.setState({
        ...
        selectedManagers: _.keys(initialTeamInfo.managers),
        selectedCoaches: _.keys(initialTeamInfo.coaches)
      });
    }
  }

  componentWillReceiveProps(nextProps) {
    const { initialTeamInfo, options } = nextProps;
    ...
    if (initialTeamInfo !== this.props.initialTeamInfo) {
      this.setState({
        teamName: initialTeamInfo.info.name,
        ageGroup: initialTeamInfo.info.ageGroup,
        division: initialTeamInfo.info.division,
  ...
  render() {
    const { classes, isOpen, isLoading, institutionID, teamID } = this.props;
