          ...
          <div className={classes.infoWrapper}>
            ...
            <Paper>
              ...
              <div className={classes.statsWrapper}>
                ...
                <div className={classes.gridItem}>
                  <TextField
                    value={theirTeamInfo.greenCards}
                    type="number"
                    margin="normal"
                  />
                </div>
              ...
              <div className={classes.statsWrapper}>
                ...
                <div className={classes.gridItem}>
                  <TextField
                    value={theirTeamInfo.longCorners}
                    type="number"
                    margin="normal"
                  />
                </div>
              ...
              <div className={classes.statsWrapper}>
                <div className={classes.gridItem}>
                  <TextField
                    value={ourTeamInfo.shortCorners}
                    type="number"
                    margin="normal"
                  />
                </div>
                ...
                <div className={classes.gridItem}>
                  <TextField
                    value={theirTeamInfo.shortCorners}
                    type="number"
                    margin="normal"
                  />
                </div>
