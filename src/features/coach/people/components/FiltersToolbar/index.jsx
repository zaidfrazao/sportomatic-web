...
class FiltersToolbar extends Component {
  ...
  toggleDialog() {
    this.setState({
      ...
      selectedType: this.state.confirmedType,
      selectedSport: this.state.confirmedSport
    });
  }
  ...
  render() {
    const { classes, isMobile, types, sports } = this.props;
    const {
      searchText,
      confirmedType,
      confirmedSport,
      ...
      <div>
        ...
        <Dialog open={isOpen} onRequestClose={() => this.toggleDialog()}>
          ...
          <DialogActions>
            ...
            <Button
              color="primary"
              onClick={() => this.handleUpdate(selectedType, selectedSport)}
            >
              Update
            </Button>
          </DialogActions>
