...
export const REQUEST_STAFF = "sportomatic-web/coach/people/REQUEST_STAFF";
export const RECEIVE_STAFF = "sportomatic-web/coach/people/RECEIVE_STAFF";
export const ERROR_LOADING_STAFF =
  "sportomatic-web/coach/people/ERROR_LOADING_STAFF";
...
const staff = state => state.coach.people.staff;
const loadingStatus = state => state.coach.people.loadingStatus;
